...
function Dashboard() {
  ...
  async function fetchDashboard() {
    try { const r = await axios.get("http://localhost:8000/api/dashboard"); setStats(r.data); }
    catch (e) { console.log(e); }
  }

  async function fetchChartData() {
    try { const r = await axios.get("http://localhost:8000/api/dashboard/chart"); setChartData(r.data); }
    catch (e) { console.log(e); }
  }
  ...
  async function loadModalData(type, date) {
    try {
      ...
      const r = await axios.get(`http://localhost:8000/api/employees/${endpoint}`);
