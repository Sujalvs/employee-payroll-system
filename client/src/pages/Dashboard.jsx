...
function Dashboard() {
  ...
  async function fetchDashboard() {
    try { const r = await axios.get("https://https://employee-payroll-system-production-9563.up.railway.app/api/dashboard"); setStats(r.data); }
    catch (e) { console.log(e); }
  }

  async function fetchChartData() {
    try { const r = await axios.get("https://https://employee-payroll-system-production-9563.up.railway.app/api/dashboard/chart"); setChartData(r.data); }
    catch (e) { console.log(e); }
  }
  ...
  async function loadModalData(type, date) {
    try {
      ...
      const r = await axios.get(`https://https://employee-payroll-system-production-9563.up.railway.app/api/employees/${endpoint}`);
