...
function Advances() {
  ...
  async function fetchAdvances() {
    const r = await axios.get("http://https://balanced-light-production-e602.up.railway.app/api/advances");
    setAdvances(r.data);
  }
  ...
  async function saveAdvance() {
    try {
      ...
      await axios.post("http://https://balanced-light-production-e602.up.railway.app/api/advances", { employeeId, amount, reason, date });
  ...
  async function deleteAdvance(id) {
    ...
    try {
      await axios.delete(`http://https://balanced-light-production-e602.up.railway.app/api/advances/${id}`);
