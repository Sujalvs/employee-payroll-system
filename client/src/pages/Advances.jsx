...
function Advances() {
  ...
  async function fetchAdvances() {
    const r = await axios.get("http://localhost:8000/api/advances");
    setAdvances(r.data);
  }
  ...
  async function saveAdvance() {
    try {
      ...
      await axios.post("http://localhost:8000/api/advances", { employeeId, amount, reason, date });
  ...
  async function deleteAdvance(id) {
    ...
    try {
      await axios.delete(`http://localhost:8000/api/advances/${id}`);
