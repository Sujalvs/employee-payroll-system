...
function Overtime() {
  ...
  async function fetchOvertime() {
    const r = await axios.get("https://https://employee-payroll-system-production-9563.up.railway.app/api/overtime");
    setRecords(r.data);
  ...
  async function saveOvertime() {
    try {
      ...
      await axios.post("https://https://employee-payroll-system-production-9563.up.railway.app/api/overtime", { employeeId, hours, rate, date });
  ...
  async function deleteRecord(id) {
    ...
    try { await axios.delete(`https://https://employee-payroll-system-production-9563.up.railway.app/api/overtime/${id}`); fetchOvertime(); toast.success("Record deleted"); }
    catch (e) { toast.error("Something went wrong"); }
  }
