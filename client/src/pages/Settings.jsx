...
function Settings() {
  ...
  async function resetToDefault() {
    ...
    setResetting(true);
    try {
      await axios.post("https://balanced-light-production-e602.up.railway.app/api/backup/reset", { resetPassword });
      setResetPassword("");
  ...
  async function fetchAdmins() {
    try { const r = await axios.get("https://balanced-light-production-e602.up.railway.app/api/auth/admins"); setAdmins(r.data); }
  ...
  async function changePassword() {
    ...
    try {
      await axios.post("https://balanced-light-production-e602.up.railway.app/api/auth/change-password", {
  ...
  async function createAdmin() {
    ...
    try {
      await axios.post("https://balanced-light-production-e602.up.railway.app/api/auth/create-admin", { username: newUsername, password: newPassword });
  ...
  async function deleteAdmin(id, username) {
    ...
    try {
      await axios.delete(`https://balanced-light-production-e602.up.railway.app/api/auth/admins/${id}`);
  ...
  async function fetchBackups() {
    try { const r = await axios.get("https://balanced-light-production-e602.up.railway.app/api/backup/list"); setBackups(r.data); }
    catch (e) { console.log(e); }
  }

  async function fetchBackupSettings() {
    try { const r = await axios.get("https://balanced-light-production-e602.up.railway.app/api/backup/settings"); setBackupSettings(r.data); }
    catch (e) { console.log(e); }
  }

  async function saveBackupSettings(updated) {
    try {
      await axios.post("https://balanced-light-production-e602.up.railway.app/api/backup/settings", updated);
  ...
  async function createManualBackup() {
    ...
    try {
      const r = await axios.post("https://balanced-light-production-e602.up.railway.app/api/backup/create");
  ...
  function downloadBackup(filename) {
    window.open(`https://balanced-light-production-e602.up.railway.app/api/backup/download/${filename}`, "_blank");
  }

  async function deleteBackup(filename) {
    if (!await confirmDialog(`Delete backup "${filename}"?`, "Yes, delete")) return;
    try {
      await axios.delete(`https://balanced-light-production-e602.up.railway.app/api/backup/${filename}`);
  ...
  async function handleRestoreFile(e) {
    ...
    try {
      ...
      const r = await axios.post("https://balanced-light-production-e602.up.railway.app/api/backup/restore", formData, {
  ...
  async function exportAllData() {
    try {
      const [emps, att, adv, ot, pmts] = await Promise.all([
        axios.get("https://balanced-light-production-e602.up.railway.app/api/employees"),
        axios.get("https://balanced-light-production-e602.up.railway.app/api/attendance"),
        axios.get("https://balanced-light-production-e602.up.railway.app/api/advances"),
        axios.get("https://balanced-light-production-e602.up.railway.app/api/overtime"),
        axios.get("https://balanced-light-production-e602.up.railway.app/api/payments"),
      ]);
